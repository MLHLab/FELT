...
GOOGLE_API_KEY = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"  # GOOGLE API key is set here
...
test_vectors_1 = np.array([embed_model.get_text_embedding(text) for text in test_data['Consumer complaint narrative']])
test_vectors = test_vectors_1.astype(np.float32)
faiss.normalize_L2(test_vectors)

train_vectors_1 = np.array([embed_model.get_text_embedding(text) for text in train_data['Consumer complaint narrative']])
